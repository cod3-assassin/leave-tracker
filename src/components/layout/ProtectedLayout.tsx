...
export default function ProtectedLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex">
      ...
      {isSidebarOpen && (
        <div
          className="fixed top-0 bottom-0 left-0 right-0 bg-gray-900/40 z-20 sm:hidden"
      ...
      <div className="flex-1 flex flex-col">
        <div className="fixed top-0 left-0 right-0 z-20 h-16 bg-white shadow-sm sm:ml-64">
          <Header toggleSidebar={toggleSidebar} isSidebarOpen={isSidebarOpen} />
        </div>
        <main
          className="flex-1 mt-16  sm:p-6  overflow-y-auto max-h-[calc(100vh-4rem)] transition-all duration-300 sm:ml-64"
        >
          <Outlet />
        </main>
      </div>
